...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2026 at 08:42 AM
...
(1, 'Admin', 'admin@gmail.com', '$2y$10$7LOSNnhH61YkPmfaA9J2gOD8Hr8qQ9hMtyvnkLgXZbCxAVij00dry', 'superadmin', NULL, '', 1, 1, '2026-04-07 11:31:58', '::1', 33, '', '2026-03-30 13:52:29', NULL, NULL, '2026-03-26 09:21:34'),
...
(1, 'Top Industrial Valves Used in Commercial Projects', 'top-industrial-valves', 'Learn about the most commonly used industrial valves in commercial systems.', '<p>Industrial valves play a crucial role in controlling fluid flow in commercial systems. Ball valves, butterfly valves, and gate valves are widely used.</p>', 'assets/img/blog/blog-01.png', 'Industrial valves image', 3, 'valves,industrial,commercial', 150, 5, 1, '2026-04-04', 5, 'Best Industrial Valves Guide', 'Explore top industrial valves used in commercial applications.', 'industrial valves', '/blog/top-industrial-valves', 'Top Industrial Valves', 'Guide on industrial valves', 'assets/img/blog/blog-01.png', 'website', 'Industrial Valves Guide', 'Learn about valves', 'summary', 'index,follow', 'Article', '{\"@context\":\"https://schema.org\",\"@type\":\"Article\",\"headline\":\"Industrial Valves\"}', '2026-04-04 14:05:09', '2026-04-06 13:00:45'),
(2, 'Understanding Boiler Tubes in Industries', 'boiler-tubes-guide', 'Complete guide about boiler tubes and their applications.', '<p>Boiler tubes are essential components in heat exchange systems. They are designed to withstand high pressure and temperature.</p>', 'assets/img/blog/Ball-Valve.png', 'Boiler tubes image', 3, 'boiler,tubes,industry', 113, 3, 1, '2026-04-04', 6, 'Boiler Tubes Guide', 'Learn about boiler tubes and their uses.', 'boiler tubes', '/blog/boiler-tubes-guide', 'Boiler Tubes', 'All about boiler tubes', 'assets/img/blog/blog-02.png', 'website', 'Boiler Tubes Info', 'Boiler tubes explained', 'summary', 'index,follow', 'Article', '{\"@context\":\"https://schema.org\",\"@type\":\"Article\"}', '2026-04-04 14:05:09', '2026-04-07 06:09:20'),
(3, 'wvfbgfh', 'wvfbgfh', 'w1s2d3efgvrtb', 'q', 'assets/img/blog/Boiler-Tubes.png', 'sdwgfrt', 3, 'aqsdwefr', 12, 0, 1, '2026-04-04', 6, '123w', 'aqsxcdvs gf', '', 'ASXDCVF', 'zaxcsdvf', 'adsvfg', 'assets/img/blog/wvfbgfh-69d116cbf09b6.webp', 'website', 'ZAXCSDF', 'agfrdtgf', 'summary', 'index,follow', 'Article', '{\"@context\":\"https://schema.org\",\"@type\":\"Article\",\"headline\":\"wvfbgfh\",\"description\":\"aqsxcdvs gf\",\"image\":\"https://nirajindustry.com/assets/img/blog/wvfbgfh-69d116cbf09b6.webp\",\"author\":{\"@type\":\"Organization\",\"name\":\"Niraj Industries\"},\"publisher\":{\"@type\":\"Organization\",\"name\":\"Niraj Industries\"},\"datePublished\":\"2026-04-04T00:00\",\"dateModified\":\"2026-04-04 15:49:00\",\"url\":\"ASXDCVF\",\"keywords\":\"aqsdwefr\"}', '2026-04-04 13:34:37', '2026-04-06 13:48:19'),
(4, 'Ball Valve vs Butterfly Valve', 'ball-vs-butterfly-valve', 'Comparison between ball valves and butterfly valves.', '<p>Ball valves provide tight sealing, while butterfly valves are lightweight and cost-effective.</p>', 'assets/img/blog/Boiler-Mounting.png', 'Valve comparison', 3, 'ball valve,butterfly valve', 79, 1, 1, '2026-04-04', 5, 'Ball vs Butterfly Valve', 'Compare ball and butterfly valves', 'valve comparison', '/blog/ball-vs-butterfly-valve', 'Valve Comparison', 'Ball vs Butterfly', 'assets/img/blog/blog-04.png', 'website', 'Valve Guide', 'Comparison guide', 'summary', 'index,follow', 'Article', '{\"@context\":\"https://schema.org\",\"@type\":\"Article\"}', '2026-04-04 14:05:09', '2026-04-06 13:03:43'),
(5, 'Boiler Mountings Explained', 'boiler-mountings', 'Important boiler mountings and their functions.', '<p>Boiler mountings ensure safe operation of boilers. These include safety valves, pressure gauges, etc.</p>', 'assets/img/blog/Bras-Pipe-Fittings.png', 'Boiler mountings', 3, 'boiler,mountings', 88, 4, 1, '2026-04-04', 6, 'Boiler Mountings Guide', 'Learn about boiler mountings', 'boiler mountings', '/blog/boiler-mountings', 'Boiler Guide', 'Mountings explained', 'assets/img/blog/blog-05.png', 'website', 'Boiler Info', 'Boiler details', 'summary', 'index,follow', 'Article', '{\"@context\":\"https://schema.org\",\"@type\":\"Article\"}', '2026-04-04 14:05:09', '2026-04-07 06:13:52'),
(6, 'Commercial Piping Systems Overview', 'commercial-piping-systems', 'Overview of piping systems used in industries.', '<p>Commercial piping systems include steel, copper, and PVC pipes used across industries.</p>', 'assets/img/blog/Butterfly-Valve.png', 'Piping systems', 3, 'piping,commercial', 111, 6, 1, '2026-04-04', 7, 'Piping Systems Guide', 'Complete piping systems overview', 'commercial piping', '/blog/commercial-piping-systems', 'Piping Systems', 'Industrial piping guide', 'assets/img/blog/blog-06.png', 'website', 'Piping Info', 'All about piping', 'summary', 'index,follow', 'Article', '{\"@context\":\"https://schema.org\",\"@type\":\"Article\"}', '2026-04-04 14:05:09', '2026-04-06 12:44:19'),
...
(13, 'anweydugt3ectfct', 'jdcuygeyeg', 'Electrichewiub d', '2hydgfu2t', 'j2xgycetf', '', 'eeihcydgvr', '', 'cdv fsddbghnv', '', 'azx ds', 'hjws', '2iygdy', 'swhy2g', 'de3cfrv', 'ec3rvf', 'assets/img/products/jdcuygeyeg-2-69d0cc849ac68.webp', '', '', 1, 'ed3frctvgbytnhy', 'zaXCSWADEVFR', 'saCX zvf', 'ed3cfrvt', 'assets/img/products/jdcuygeyeg-69d0cc8488433.webp', 'IBR', '', 'asC V', 2.9, 5, 1, 0, '2026-04-04 08:32:04', 'QADWQEFW', 'QA1SDWEFR', '', 'DWEFGRTHY', 'Q1ASWDXECWERFVG', 'QDWEFT', 'assets/img/products/jdcuygeyeg-69d0cc8488433.webp', 'article', 'SWDEWFV', 'rfzfwrdzrdqrxd', 'summary_large_image', 'index,follow', 'Product', '{\"@context\":\"https://schema.org\",\"@type\":\"Product\",\"name\":\"anweydugt3ectfct\",\"description\":\"QA1SDWEFR\",\"image\":\"https://nirajindustry.com/assets/img/products/jdcuygeyeg-69d0cc8488433.webp\",\"brand\":{\"@type\":\"Brand\",\"name\":\"cdv fsddbghnv\"},\"sku\":\"\",\"url\":\"DWEFGRTHY\",\"category\":\"Electrichewiub d\"}', '2026-04-04 14:06:25');
