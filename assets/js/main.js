;(function($){
  ...
  // ==========================================
  // 🔴 FIX 1: PROGRESS WRAP NULL CHECK
  // PEHLE WALA CODE (YE CRASH KARTA THA):
  //   var progressPath = document.querySelector(".progress-wrap path");
  //   var pathLength = progressPath.getTotalLength(); // NULL CRASH HERE
  //
  // AB NEECHE WALA FIXED CODE HAI — if(progressPath) se wrap kiya hai
  // ==========================================
  var progressPath = document.querySelector(".progress-wrap path");
  if (progressPath) {
  ...
  // ==========================================
  // 🔴 FIX 2: RANGE SLIDER NULL CHECK
  // PEHLE WALA CODE (YE BHI CRASH KARTA THA):
  //   const slider = document.getElementById("slider");
  //   slider.oninput = function() { ... }  // NULL CRASH AGAR PAGE PE NA HO
  //
  // AB NEECHE WALA FIXED CODE HAI — if(slider && sliderValue) se wrap kiya hai
  // ==========================================
  const slider = document.getElementById("slider");
