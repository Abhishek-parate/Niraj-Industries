<?php
// C:\xamppnew\htdocs\nirajindustries\admin\blog\add.php
                                    ...
                                    <div class="tab-pane fade show active" id="tab-meta" role="tabpanel">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="serp-preview">
                                                <div class="serp-url" id="serpUrl">nirajindustries.com › blog › <span id="serpSlug">your-post-slug</span></div>
...
function autoFillCanonical(slug) {
    ...
    if (canon && canon.value === "") {
        canon.value = window.location.origin + "/nirajindustries/blog/" + slug;
    }
}
