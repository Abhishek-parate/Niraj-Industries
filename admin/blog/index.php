<?php
// C:\xampp\htdocs\nirajindustries\admin\blog\index.php
...
function openSeoModal(id) {
    ...
    if (d.metaTitle || d.metaDesc) {
        metaHtml = "<div class=\'card mb-4 border rounded-3 bg-light shadow-none\'><div class=\'card-body p-3\'><div class=\'small text-muted mb-1 font-monospace\' style=\'font-size:0.75rem;\'>nirajindustriess.com \u203a blog \u203a " + (d.slug || "") + "</div><div class=\'fs-5 fw-medium mb-1\' style=\'color:#1a0dab;max-width:100%;overflow:hidden;text-overflow:ellipsis;\'>" + (d.metaTitle || "<em class=\'text-muted\'>No meta title</em>") + "</div><div class=\'small text-dark\' style=\'line-height:1.4;\'>" + (d.metaDesc || "<em class=\'text-muted\'>No meta description</em>") + "</div></div></div>";
    }
