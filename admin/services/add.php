<?php
// C:\xamppnew\htdocs\nirajindustries\admin\services\add.php
                                ...
                                <div class="tab-content p-3">
                                    ...
                                    <div class="tab-pane fade show active" id="t-basic">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="canonical_url" class="form-control"
                                                placeholder="https://nirajindustries.com/service/your-slug" value="<?= $p('canonical_url') ?>">
                                        </div>
                                        <label class="form-label">SERP Preview</label>
                                        <div class="serp-box shadow-sm">
                                            <div class="serp-url">nirajindustries.com › service › <span id="serpSlug">your-slug</span></div>
                                    ...
                                    <div class="tab-pane fade" id="t-og">
                                        ...
                                        <div class="og-card shadow-sm">
                                            ...
                                            <div class="og-body">
                                                <div class="og-domain">nirajindustries.com</div>
